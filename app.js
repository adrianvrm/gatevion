  ...
  if(bookingForm){
    ...
    bookingForm.addEventListener('submit', (e)=>{
      ...
      const reservation = {
        ...
        travelCountry,
        flightNumber,
        // Date personale detaliate – mapate exact pe câmpurile pe care le așteaptă admin-ul
        birthDate: document.getElementById('birthDate')?.value || getVal('input[name="birthDate"]'),
        cnp: getVal('input[name="cnp"]'),
        address: getVal('input[name="address"]'),
        licenseId: getVal('input[name="licenseId"]'),
        nationalId: getVal('input[name="nationalId"]'),
        notes: getVal('textarea[name="extraNotes"]'),
